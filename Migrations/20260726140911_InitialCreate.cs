        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassSubjects_Teachers_TeacherId1",
                        column: x => x.TeacherId1,
                        principalTable: "Teachers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectId = table.Column<int>(type: "integer", nullable: false),
                    ClassId = table.Column<int>(type: "integer", nullable: true),
                    ContinuousTest1 = table.Column<double>(type: "double precision", precision: 5, scale: 2, nullable: true),
                    ContinuousTest2 = table.Column<double>(type: "double precision", precision: 5, scale: 2, nullable: true),
                    EndTermExam = table.Column<double>(type: "double precision", precision: 5, scale: 2, nullable: true),
                    TotalScore = table.Column<double>(type: "double precision", precision: 5, scale: 2, nullable: true),
                    Grade = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: true),
                    Remark = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<int>(type: "integer", nullable: false),
                    SubjectId = table.Column<int>(type: "integer", nullable: false),
                    Test1 = table.Column<double>(type: "double precision", precision: 5, scale: 2, nullable: true),
                    Test2 = table.Column<double>(type: "double precision", precision: 5, scale: 2, nullable: true),
                    EndTerm = table.Column<double>(type: "double precision", precision: 5, scale: 2, nullable: true),
                    Year = table.Column<int>(type: "integer", nullable: false),
                    Term = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassSubjects_TeacherId1",
                table: "ClassSubjects",
                column: "TeacherId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Marks_StudentId_SubjectId_Year_Term",
                table: "Marks",
                columns: new[] { "StudentId", "SubjectId", "Year", "Term" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentMarks_StudentId_SubjectId_Year_Term",
                table: "StudentMarks",
                columns: new[] { "StudentId", "SubjectId", "Year", "Term" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_Class_Stream",
                table: "Students",
                columns: new[] { "Class", "Stream" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentSubjects_TeacherId1",
                table: "StudentSubjects",
                column: "TeacherId1");

            migrationBuilder.CreateIndex(
                name: "IX_StudentSubjects_UniqueAllocation",
                table: "StudentSubjects",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherSubjectAllocations_ClassId_SubjectId",
                table: "TeacherSubjectAllocations",
                columns: new[] { "ClassId", "SubjectId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TeacherSubjectAllocations_SubjectId",
                table: "TeacherSubjectAllocations",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherSubjectAllocations_TeacherId",
                table: "TeacherSubjectAllocations",
                column: "TeacherId");
